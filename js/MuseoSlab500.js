...
suffix="_unhinted";var fonts=[{"fontFamily":"MuseoSlab-500","url":wfpath+"268971_0"+suffix+"_0."+webfontType}];var len=fonts.length;document.write("<style>");for(var i=0;i<len;i++){if(webfontType=="svg#wf"){var format="svg";}
